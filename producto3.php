...
<head>
    ...
    <style>
        ...
        @media (max-width: 600px) {
            .product-container {
                padding: 15px;
                width: calc(100% - 30px); /* Ajuste en pantallas más pequeñas */
            }
...
<body>
    <div class="product-container">
        ...
        <img src="https://cdnx.jumpseller.com/keyxpress-colombia/image/44245898/resize/610/610?1704869625" alt="Imagen del Producto">
