...
<body>
    ...
    <div id="main">
        ...
        <div class="info-section">
            ...
            <p>Realiza tus compras de manera segura con nosotros. ¡Haz clic en el botón para Ver las Noticias Nuevas de Windows!</p>
            <button class="btn-buy" onclick="location.href='Noti.php'">Ir a Noticias</button>
        </div>
    </div>
