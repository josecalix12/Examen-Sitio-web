...
<head>
    ...
    <style>
        ...
        .form-container input {
            ...
            border-radius: 4px;
            width: 100%;
            box-sizing: border-box; /* Ajuste de caja para el padding y el borde */
        }
    </style>
</head>
<body>
    <div class="product-container">
        ...
        <img src="https://imagenes.deltron.com.pe/images/productos/on-line/items/large/ms/fq/msfqc10553.jpg" alt="Imagen del Producto">
